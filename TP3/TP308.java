...
for(int i = 0; i < n; i++) 
{
    try 
    {
        ...
        else if(partes[0].equals("R"))
        {
            ...
            Pokemon encontrado = selecionados.remover();
            System.out.println("(R) " + encontrado.getName());
...
class Celula {
 ...
 class Pilha {
	...
	public void mostraPilha() {
		...
		mostraPilha(topo, tamanho - 1);
	}

	private void mostraPilha(Celula i, int tamanho) {
        
		if (i != null) {
			mostraPilha(i.prox, tamanho - 1);
			System.out.print("[" + tamanho + "] "); Pokemon.printar(i.elemento);
		}
	}
